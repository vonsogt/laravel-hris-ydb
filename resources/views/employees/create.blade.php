                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="bloodTypeInputSelect" class="form-select mb-3" name="blood_type" aria-label="Pilih golongan darah">
                                ...
                                @foreach ($data['bloodTypeOptions'] as $key => $option)
                                    <option @if (old('blood_type', '') == $key) selected @endif value="{{ $key }}">{{ strtoupper($option) }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="statusInputSelect" class="form-select mb-3" name="status" aria-label="Pilih status">
                                ...
                                <option @if (old('status', '') == "GTY") selected @endif value="GTY">GTY</option>
                                <option @if (old('status', '') == "GTTY") selected @endif value="GTTY">GTTY</option>
                                <option @if (old('status', '') == "PTY") selected @endif value="PTY">PTY</option>
                                <option @if (old('status', '') == "PTTY") selected @endif value="PTTY">PTTY</option>
                            </select>
                        </div>
                        {{-- <div class="mb-3">
