                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="month" id="monthInput">
                                ...
                                <option value="1" @if (old('month', $salary->getMonthFromDate()) == "1") selected @endif>Januari</option>
                                <option value="2" @if (old('month', $salary->getMonthFromDate()) == "2") selected @endif>Februari</option>
                                <option value="3" @if (old('month', $salary->getMonthFromDate()) == "3") selected @endif>Maret</option>
                                <option value="4" @if (old('month', $salary->getMonthFromDate()) == "4") selected @endif>April</option>
                                <option value="5" @if (old('month', $salary->getMonthFromDate()) == "5") selected @endif>Mei</option>
                                <option value="6" @if (old('month', $salary->getMonthFromDate()) == "6") selected @endif>Juni</option>
                                <option value="7" @if (old('month', $salary->getMonthFromDate()) == "7") selected @endif>Juli</option>
                                <option value="8" @if (old('month', $salary->getMonthFromDate()) == "8") selected @endif>Agustus</option>
                                <option value="9" @if (old('month', $salary->getMonthFromDate()) == "9") selected @endif>September</option>
                                <option value="10" @if (old('month', $salary->getMonthFromDate()) == "10") selected @endif>Oktober</option>
                                <option value="11" @if (old('month', $salary->getMonthFromDate()) == "11") selected @endif>November</option>
                                <option value="12" @if (old('month', $salary->getMonthFromDate()) == "12") selected @endif>Desember</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="dateInputYear">Tahun</label>
                            <input type="text" name="year" class="form-control" id="dateInputYear" value="{{ old('year', $salary->getYearFromDate()) }}" placeholder="Masukkan tahun">
                        </div>
                        <div class="mb-3">
