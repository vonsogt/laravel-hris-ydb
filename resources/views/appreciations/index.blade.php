    ...
    @if (auth()->getDefaultDriver() == 'web')
        <div class="row g-4 mb-3">
            <div class="col-sm-auto">
                <div>
                    <a href="{{ route('appreciations.create') }}" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Tambah penghargaan</a>
                </div>
            </div>
        </div>
    @else
        @if (auth()->user()->position->name == 'Staf HRD')
            <div class="row g-4 mb-3">
                <div class="col-sm-auto">
                    <div>
                        <a href="{{ route('employee.appreciations.create') }}" class="btn btn-success add-btn" id="create-btn"><i class="ri-add-line align-bottom me-1"></i> Tambah penghargaan</a>
                    </div>
                </div>
            </div>
        @endif
                ...
                <div class="card-body">
                    <div id="customerList">
                        ...
                        <div class="table-responsive mt-3 mb-1">
                            <table class="table align-middle table-nowrap" id="appreciationTable">
    ...
    <script>
        $(function() {
            ...
            var table = $('#appreciationTable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ auth()->getDefaultDriver() == 'api' ? route('employee.appreciations.index') : route('appreciations.index') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
